...
$router->match('GET|POST', '/product/add_cart', AjaxController::class . '@addCart');
$router->match('GET|POST', '/cart', AjaxController::class . '@AddToCart');
$router->match('GET|POST', '/product/dele_cart', AjaxController::class . '@deleCart');
