                                        ...
                                        <div class="item-cart cartItem_37834033" psId="37834033">
                                            <div style="width: 19%" class="image">
                                                <a href="/giay-nike-air-force-1-low-shadow-sunset-pulse-w-40-p37834033.html"
                                                    ...
                                                    <img src="{{ $item['image'] }}" width="120" height="auto"
                                                        alt="{{ $item['name'] }}">
                                                </a>
                                            </div>
                                            <div style="width: 28%;align-items: flex-start;" class="a-center">
                                                <h2 class="product-name">
                                                    <a class="tp_product_name"
                                                        href="/product/{{ $item['p_id'] }}">{{ $item['name'] }}</a>
                                                </h2>
                                            </div>
                                            ...
                                            <div style="width: 5%" class="a-center">
                                                <a class="button remove-item remove-item-cart" title="Xóa"
                                                 >
                                                    <span id="dele-cart" data-id="{{ $item['id'] }}"><i class="fas fa-trash-alt"></i></span>
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <li class="clearfix">
                                                    <div class="inline-block">
                                                        <span>Tổng tiền:</span> <strong>
                                                            <span class="totals_price price">{{ number_format($item['price'] * $item['quantity']) }}</span>
                                                        </strong>
                                                    </div>
