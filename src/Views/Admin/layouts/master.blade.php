...
<head>
    ...
    <!-- Layout config Js -->
    <script src="/../assets/admin/assets/js/layout.js"></script>
    <!-- Bootstrap Css -->
...
<body>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="/../assets/admin/assets/images/logo-light.png" alt=""
                                        height="17">
                                </span>
                            </a>
                        </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar style="max-height: 320px;">
                                    ...
                                    <div class="notification-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                            <div class="d-flex">
                                                <img src="/../assets/admin/assets/images/users/avatar-3.jpg"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <img id="header-lang-img" src="/../assets/admin/assets/images/flags/us.svg"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/us.svg" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/spain.svg" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/germany.svg" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/italy.svg" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/russia.svg" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/china.svg" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/french.svg" alt="user-image"
                                        class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="/../assets/admin/assets/images/flags/ae.svg" alt="user-image"
                                        class="me-2 rounded" height="18">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="/../assets/admin/assets/images/brands/github.png"
                                                    alt="Github">
                                                <span>GitHub</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="/../assets/admin/assets/images/brands/bitbucket.png"
                                                    alt="bitbucket">
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="/../assets/admin/assets/images/brands/dribbble.png"
                                                    alt="dribbble">
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="/../assets/admin/assets/images/brands/dropbox.png"
                                                    alt="dropbox">
                                                <span>Dropbox</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="/../assets/admin/assets/images/brands/mail_chimp.png"
                                                    alt="mail_chimp">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="/../assets/admin/assets/images/brands/slack.png"
                                                    alt="slack">
                                                <span>Slack</span>
                                            </a>
                                        </div>
                                ...
                                <div data-simplebar style="max-height: 300px;">
                                    <div class="p-2">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="/../assets/admin/assets/images/products/img-1.png"
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="/../assets/admin/assets/images/products/img-2.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                                        <a href="apps-ecommerce-product-details.html"
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="/../assets/admin/assets/images/products/img-3.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                                        <a href="apps-ecommerce-product-details.html"
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="/../assets/admin/assets/images/products/img-6.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                                        <a href="apps-ecommerce-product-details.html"
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="/../assets/admin/assets/images/products/img-5.png"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                                        <a href="apps-ecommerce-product-details.html"
                                ...
                                <div class="tab-content position-relative" id="notificationItemsTabContent">
                                    <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            ...
                                            <div
                                                class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    <img src="/../assets/admin/assets/images/users/avatar-8.jpg"
                                                        class="me-3 rounded-circle avatar-xs flex-shrink-0"
                                                        alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="#!" class="stretched-link">
                                    ...
                                    <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            ...
                                            <div class="text-reset notification-item d-block dropdown-item">
                                                <div class="d-flex">
                                                    <img src="/../assets/admin/assets/images/users/avatar-6.jpg"
                                                        class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                    <div class="flex-grow-1">
                                                        <a href="#!" class="stretched-link">
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="/../assets/admin/assets/images/sidebar/img-1.jpg" alt=""
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="/../assets/admin/assets/images/sidebar/img-2.jpg" alt=""
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="/../assets/admin/assets/images/sidebar/img-3.jpg" alt=""
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="/../assets/admin/assets/images/sidebar/img-4.jpg" alt=""
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
    ...
    <script src="/../assets/admin/assets/libs/node-waves/waves.min.js"></script>
    <script src="/../assets/admin/assets/libs/feather-icons/feather.min.js"></script>
    <script src="/../assets/admin/assets/js/pages/plugins/lord-icon-2.1.0.js"></script>
    <script src="/../assets/admin/assets/js/plugins.js"></script>

    <!-- apexcharts -->
    <script src="/../assets/admin/assets/libs/apexcharts/apexcharts.min.js"></script>

    <!-- Vector map-->
    <script src="/../assets/admin/assets/libs/jsvectormap/js/jsvectormap.min.js"></script>
    <script src="/../assets/admin/assets/libs/jsvectormap/maps/world-merc.js"></script>

    <!--Swiper slider js-->
    <script src="/../assets/admin/assets/libs/swiper/swiper-bundle.min.js"></script>

    <!-- Dashboard init -->
    <script src="/../assets/admin/assets/js/pages/dashboard-ecommerce.init.js"></script>
